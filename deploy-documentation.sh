...
docs=/opt/Development/Projects/loginservice/docs
...
git push -f git@github.com:philcal/loginservice.git master:gh-pages
#git push -f https://github.com/tooltwist/loginservice.git master:gh-pages
